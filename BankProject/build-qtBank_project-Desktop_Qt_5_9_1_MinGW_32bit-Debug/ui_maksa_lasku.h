...
public:
    ...
    void setupUi(QWidget *Maksa_Lasku)
    {
        ...
        widget = new QWidget(groupBox_Maksa_lasku);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(10, 60, 221, 176));
        verticalLayout_3 = new QVBoxLayout(widget);
        verticalLayout_3->setObjectName(QStringLiteral("verticalLayout_3"));
        verticalLayout_3->setContentsMargins(0, 0, 0, 0);
        horizontalLayout_3 = new QHBoxLayout();
        horizontalLayout_3->setObjectName(QStringLiteral("horizontalLayout_3"));
        label_Maksaja = new QLabel(widget);
        ...
        lineEdit_Maksaja = new QLineEdit(widget);
        ...
        pushButton_Maksa = new QPushButton(widget);
        ...
        verticalLayout_2->addWidget(pushButton_Kirjaudu_ulos);
    ...
    void retranslateUi(QWidget *Maksa_Lasku)
    {
        ...
        pushButton_Kirjaudu_ulos->setText(QApplication::translate("Maksa_Lasku", "Kirjaudu ulos", Q_NULLPTR));
    } // retranslateUi
