...
public:
    ...
    void setupUi(QWidget *PankkiMenu)
    {
        ...
        PankkiMenu->resize(400, 362);
        groupBox = new QGroupBox(PankkiMenu);
        groupBox->setObjectName(QStringLiteral("groupBox"));
        groupBox->setGeometry(QRect(50, 10, 281, 331));
        ...
        pushButton_Saldo->setFont(font1);
        ...
        pushButton_Nosta_rahaa->setFont(font1);
        ...
        pushButton_Talletus->setFont(font1);
        ...
        pushButton_Tilintapahtumat->setFont(font1);
        ...
        pushButton_Hae_lainaa->setFont(font1);
        ...
        pushButton_Maksa_lasku->setFont(font1);
        ...
        pushButton_Kirjaudu_ulos->setFont(font1);
